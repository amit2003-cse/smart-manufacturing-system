...
const BarcodeInput = ({ label = "SCAN BARCODE", placeholder = "Scan barcode here...", onScan, disabled }) => {
  ...
  useEffect(() => {
    // Force focus on mount with a tiny delay to ensure DOM is ready
    const timer = setTimeout(() => {
      const inputEl = document.querySelector('.barcode-input-wrapper .dx-texteditor-input');
    ...
    <div className="filter-item barcode-input-wrapper" style={{ flex: 1 }}>
      ...
      <div className="input-with-button">
        <TextBox 
          ...
          onContentReady={(e) => e.component.focus()}
