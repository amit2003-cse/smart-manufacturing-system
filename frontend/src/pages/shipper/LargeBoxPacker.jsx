  ...
  return (
    <div className="page-container fade-in">
            ...
            {showPreview ? (
              <div className="label-production-preview">
                 <div className="label-header">
                    ...
                    <div className="carton-info-row">
                        <span className="carton-label">Carton No.:</span>
      ...
      <style>{`
        ...
        .label-production-preview { background: white; width: 100%; max-width: 700px; padding: 20px; border: 0px solid #ddd; font-family: 'Inter', sans-serif; color: black; }
        .label-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px; border-bottom: 1.5px solid #000; padding-bottom: 5px; }
        .model-info { font-size: 14px; font-weight: 700; }
        .carton-info-row { display: flex; align-items: center; gap: 8px; }
        .carton-label { font-size: 12px; font-weight: 700; }
        #cartonPreview { height: 32px !important; width: 140px !important; }
        .label-body { display: flex; justify-content: space-between; align-items: stretch; gap: 8px; }
        .barcode-column { flex: 1; display: flex; flex-direction: column; gap: 8px; }
        .unit-item { padding: 0; }
        .unit-item canvas { height: 32px !important; width: 120px !important; }
        .center-info-column { flex: 0.4; display: flex; flex-direction: column; align-items: center; justify-content: flex-start; }
        .pcs-count { font-size: 16px; font-weight: 800; margin-bottom: 0px; }
        .sn-label { font-size: 11px; font-weight: 800; margin-bottom: 2px; }
        .v-axis { display: flex; flex-direction: column; align-items: center; width: 100%; }
        .v-line-top { width: 1.5px; height: 15px; background: #000; }
        .v-line-bottom { width: 1.5px; height: 15px; background: #000; margin-top: 2px; }
        .qr-box canvas { height: 75px !important; width: 75px !important; }
